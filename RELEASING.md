...
**Before** copying this file to create a new issue titled `EPP 2026-06 M3` with label `endgame`, update the names and versions, including those in this document.
...
- [ ] Sanity check the build for the following:
  ...
  - [ ] Make sure filenames contain expected build name and milestone, e.g., `2026-06-M3`.
  - [ ] Splash screen says the expected release name with no milestone, e.g., `2026-06`.
  - [ ] `Help -> About` says the expected build name and milestone, e.g., `2026-06-M3`.
...
- [ ] Edit the [Jenkins build](https://ci.eclipse.org/packaging/job/epp/job/master/lastBuild/).
  ...
  - [ ] Edit Jenkins Build Information and name it, e.g., `2026-06 M3`.
...
- [ ] Check that this worked:
      copy the composite\*M3.jar files over the composite\*.jar files in https://download.eclipse.org/technology/epp/packages/2026-06/ -
